 ...
 * @returns string returns the key for the cache hit, otherwise returns undefined
 */
function restoreCacheV1(paths, primaryKey, restoreKeys, options, enableCrossOsArchive = false, s3Options, s3BucketName) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @returns string returns the key for the cache hit, otherwise returns undefined
 */
function restoreCacheV2(paths, primaryKey, restoreKeys, options, enableCrossOsArchive = false, s3Options, s3BucketName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const cacheEntry = {
                cacheKey: response.matchedKey,
                archiveLocation: response.signedDownloadUrl,
            };
            yield cacheHttpClient.downloadCache(cacheEntry, archivePath, options);
            const archiveFileSize = utils.getArchiveFileSizeInBytes(archivePath);
            core.info(`Cache Size: ~${Math.round(archiveFileSize / (1024 * 1024))} MB (${archiveFileSize} B)`);
            if (core.isDebug()) {
                yield (0, tar_1.listTar)(archivePath, compressionMethod);
 ...
 * @returns
 */
function saveCacheV1(paths, key, options, enableCrossOsArchive = false, s3Options, s3BucketName) {
    var _a, _b, _c, _d, _e;
    return __awaiter(this, void 0, void 0, function* () {
        const compressionMethod = yield utils.getCompressionMethod();
        let cacheId = -1;
 ...
 * @returns
 */
function saveCacheV2(paths, key, options, enableCrossOsArchive = false, s3Options, s3BucketName) {
    return __awaiter(this, void 0, void 0, function* () {
        // Override UploadOptions to force the use of Azure
        ...
        try {
            ...
            yield cacheHttpClient.saveCache(cacheId, archivePath, key, response.signedUploadUrl, options, s3Options, s3BucketName);
